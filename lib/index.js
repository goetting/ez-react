...
function createConnector(stores) {
  return function connect(Component, handlers, initProps) {
    ...
    return function (_React$PureComponent) {
      ...
      function EZWrapper() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EZWrapper.__proto__ || Object.getPrototypeOf(EZWrapper)).call.apply(_ref, [this].concat(args))), _this), _this.mounted = true, _this.state = initProps || {}, _temp), _possibleConstructorReturn(_this, _ret);
      }
      ...
      _createClass(EZWrapper, [{
        ...
        value: function componentDidMount() {
          ...
          this.events = Object.keys(handlers).map(function (name) {
            ...
            var stateHandler = normaliseHandler(handlers[name]);
