  ...
  connectClass: function connectClass(ezFlux, Component, handlers) {
    ...
    return function (_React$PureComponent) {
      ...
      function EZWrapper() {
        ...
        return _ret2 = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EZWrapper.__proto__ || Object.getPrototypeOf(EZWrapper)).call.apply(_ref, [this].concat(args))), _this), _this.activeHandlers = [], _this.willUnmount = false, _this.state = {}, _temp), _possibleConstructorReturn(_this, _ret2);
      }
