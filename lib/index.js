...
exports.connect = exports.connectClass = exports.connectInstance = exports.validateArguments = undefined;
...
function addListeners(instance, handlers, ezFlux) {
  ...
  var _loop = function _loop(i) {
    ...
    var ezReactEventListener = function ezReactEventListener() {
    ...
    activeHandlers.push({ name: eventName, ezReactEventListener: ezReactEventListener });
...
function removeListeners(handlers, ezFlux) {
  for (var i = handlers.length; i--;) {
    var _handlers$i = handlers[i],
        _name = _handlers$i.name,
        _ezReactEventListener = _handlers$i.ezReactEventListener;


    ezFlux.removeListener(_name, _ezReactEventListener);
  }
}
...
var validateArguments = exports.validateArguments = ezReact.validateArguments;
var connectInstance = exports.connectInstance = ezReact.connectInstance;
var connectClass = exports.connectClass = ezReact.connectClass;
var connect = exports.connect = ezReact.connect;