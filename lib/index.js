...
function ezReact() {
  ...
  return {
    connect: function connect(component, handlers) {
      if (isFn(component)) return _this.plugins.connectClass(component, handlers);
      return _this.plugins.connectInstance(component, handlers);
    },
    connectClass: function connectClass(Component, handlers) {
