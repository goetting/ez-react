    ...
    return (
      <div id="test-bunker">
        ...
        <ul>
          ...
          <li>Science Personel: {scientists ? 'Unknown' : 'OK'}</li>
...
export const makeStore = () => createStore({
  ...
  methods: {
    startExperiment() { 
      this.$assign({ contaminated: true, freeman: true });
    },
    contain() {
      this.$assign({ marinesSent: true, scientists: false });
    },
  },
});

export const testHandler = (store: any) => store.$copy();
